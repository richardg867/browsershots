...
"""
GUI-specific interface functions for Netscape Navigator on Microsoft Windows.
"""
...
class Gui(windows.Gui):
    """
    Special functions for Netscape Navigator on Windows.
    """
    ...
    def start_browser(self, config, url, options):
        ...
        """
        command = config['command'] or r'c:\progra~1\netscape\naviga~1\naviga~1.exe'
    ...
    def find_scrollable(self):
        ...
        navigator = self.find_window_by_title_suffix(' Netscape Navigator')
        return self.get_child_window(navigator)
