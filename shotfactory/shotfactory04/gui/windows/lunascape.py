...
"""
GUI-specific interface functions for Lunascape on Microsoft Windows.
"""
...
class Gui(base.Gui):
    """
    Special functions for Lunascape on Windows.
    """
    ...
    def start_browser(self, config, url, options):
        ...
        command = config['command'] or r'c:\progra~1\lunasc~1\lunasc~1\luna.exe'
    ...
    def find_maximizable(self):
        ...
        return self.find_window_by_classname('Lunascape6MainWnd')
