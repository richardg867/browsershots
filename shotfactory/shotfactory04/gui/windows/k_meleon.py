...
"""
GUI-specific interface functions for K-Meleon on Microsoft Windows.
"""
...
class Gui(windows.Gui):
    """
    Special functions for K-Meleon on Windows.
    """
    ...
    def start_browser(self, config, url, options):
        ...
        """
        command = config['command'] or r'c:\progra~1\k-meleon\k-meleon.exe'
