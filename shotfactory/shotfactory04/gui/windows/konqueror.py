...
"""
GUI-specific interface functions for Konqueror on Microsoft Windows.
"""
...
class Gui(windows.Gui):
    """
    Special functions for Konqueror on Windows.
    """
    ...
    def start_browser(self, config, url, options):
        ...
        """
        # The KDE installer uses ProgramData on Vista onwards
        defcmd = r'c:\programdata\kde\bin\konqueror.exe'
        if not os.path.exists(defcmd):
            defcmd = r'c:\progra~1\kde\bin\konqueror.exe'
